...
def main():
    ...
    not_tested = analysis.average_of_simulations("not_tested")
    biweekly = analysis.average_of_simulations("tested_biweekly")
    weekly = analysis.average_of_simulations("tested_weekly")
