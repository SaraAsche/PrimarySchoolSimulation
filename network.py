...
class Network:
    ...
    def generate_interactions_for_network(self, i):
        #print(f'Jeg har kjørt {i+1} ganger')
        ...
        for i in range(len(self.students)):
            ...
            for j in range(len(self.students)):
                ...
                if self.students[j] in dayGraph[stud1]:
                    stud1.bias_vector[stud2] += dayGraph[stud1][self.students[j]]['count'] # evt  += dayGraph[i][j]['count']*stortNokTall
